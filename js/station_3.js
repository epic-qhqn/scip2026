...
const Station3 = {
    ...
    renderUI() {
        ...
        this.container.innerHTML = `
            ...
            <div style="position: relative; width: 140px; height: 300px; display: flex; flex-direction: column; align-items: center; justify-content: flex-end; padding-bottom: 20px; transform: scale(1.3); transform-origin: bottom center;">
